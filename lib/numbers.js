...
export class Numbers {
  ...
  activate(event: MouseEvent) {
    ...
    this.subscriptions.add(disposableEvent(document.body, 'mousemove', debounce(e => {
      ...
      // $FLowIgnore: This is our own magic method, set by intentions
      this.element.padTextContent(newValue.length)
    }, 16, true)))
    this.subscriptions.add(disposableEvent(document.body, 'mouseup', () => {
      this.dispose()
    }))
  }
  dispose() {
