...
import {debounce, disposableEvent, handlePositionClass, clearPositionClass, getFontSize} from '../helpers'
...
export default class NumberRange {
  ...
  static getElement(length) {
    ...
    const leftPosition = '-' + (length * fontSize) + 'px'

    element.textContent = '_'.repeat(length)
    element.style.left = leftPosition
    element.style.width = (length * fontSize) + 'px'
